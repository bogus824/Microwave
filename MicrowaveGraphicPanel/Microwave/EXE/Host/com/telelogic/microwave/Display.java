...
//!	Generated Date	: Sat, 11, May 2019 
	File Path	: EXE/Host/com/telelogic/microwave/Display.java
*********************************************************************/
...
//----------------------------------------------------------------------------
// com/telelogic/microwave/Display.java                                                                  
//----------------------------------------------------------------------------
...
public class Display implements RiJStateConcept, Animated {
    ...
    public static AnimClass animClassDisplay = new AnimClass("com.telelogic.microwave.Display",false);
    //#]
    ...
    protected Microwave itsMicrowave;		//## link itsMicrowave 
    ...
    */
    ...
    //## auto_generated 
    public void __setItsMicrowave(Microwave p_Microwave) {
        itsMicrowave = p_Microwave;
        if(p_Microwave != null)
            {
                animInstance().notifyRelationAdded("itsMicrowave", p_Microwave);
            }
        else
            {
                animInstance().notifyRelationCleared("itsMicrowave");
            }
    }
    
    //## auto_generated 
    public void _setItsMicrowave(Microwave p_Microwave) {
        if(itsMicrowave != null)
            {
                itsMicrowave.__setItsDisplay(null);
            }
        __setItsMicrowave(p_Microwave);
    }
    
    //## auto_generated 
    public void setItsMicrowave(Microwave p_Microwave) {
        if(p_Microwave != null)
            {
                p_Microwave._setItsDisplay(this);
            }
        _setItsMicrowave(p_Microwave);
    }
    
    //## auto_generated 
    public void _clearItsMicrowave() {
        animInstance().notifyRelationCleared("itsMicrowave");
        itsMicrowave = null;
    }
    ...
    public class Reactive extends RiJStateReactive implements AnimatedReactive {
        ...
        public int WaitForKeys_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(evKeyPress.evKeyPress_microwave_telelogic_com_id))
                {
            ...
            if(params.key == 'n')
                {
                    ...
                    WaitForKeys_exit();
                    //#[ transition 2 
                    itsMicrowave.gen(new evStartNormal());
                    //#]
                    WaitForKeys_entDef();
                    ...
                    if(params.key == 'g')
                        {
                            ...
                            WaitForKeys_exit();
                            //#[ transition 3 
                            itsMicrowave.gen(new evStartGrill());
                            //#]
                            WaitForKeys_entDef();
                            ...
                            if(params.key =='u')
                                {
                                    ...
                                    WaitForKeys_exit();
                                    //#[ transition 4 
                                    itsMicrowave.gen(new evStartUnfrozing());
                                    //#]
                                    WaitForKeys_entDef();
                                    ...
                                    if(params.key =='w')
                                        {
                                            ...
                                            WaitForKeys_exit();
                                            //#[ transition 5 
                                            itsMicrowave.gen(new evStartWashing());
                                            //#]
                                            WaitForKeys_entDef();
                                                            ...
                                                            if(params.key =='s')
                                                                {
                                                                    ...
                                                                    WaitForKeys_exit();
                                                                    //#[ transition 8 
                                                                    itsMicrowave.gen(new evNoElectricity());
                                                                    //#]
                                                                    WaitForKeys_entDef();
                                                                    ...
                                                                    if(params.key =='p')
                                                                        {
                                                                            ...
                                                                            WaitForKeys_exit();
                                                                            //#[ transition 9 
                                                                            itsMicrowave.gen(new evElectricity());
                                                                            //#]
                                                                            WaitForKeys_entDef();
    ...
    public void addRelations(AnimRelations msg) {
        ...
        msg.add("itsMicrowave", false, true, itsMicrowave);
    }
